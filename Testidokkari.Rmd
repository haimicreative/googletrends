...
Raskaustesti, viive 9 kuukautta
Alkuraskaus, viive 8 kuukautta
Raskausoireet, viive 10 kuukautta
Raskaus Oireet, viive 9 kuukautta.
...
fit_predictors <- dataset %>% dplyr::filter(between(timestamp,as.Date("2010-01-01"),as.Date("2022-07-01"))) %>% 
      model(Naive=ARIMA(log(total) ~ 0 + pdq(1,0,1) + PDQ(2,1,1)),
            raskaustestiL9=ARIMA(log(total) ~ 0 + pdq(1,0,1) + PDQ(2,1,1) + log(raskaustesti_L9)),
            alkuraskausL8=ARIMA(log(total) ~ 0 + pdq(1,0,1) + PDQ(2,1,1) + log(alkuraskaus_L8)),
            raskausoireetL10=ARIMA(log(total) ~ 0 + pdq(1,0,1) + PDQ(2,1,1) + log(raskausoireet_L10)),
            raskaus_oireetL9=ARIMA(log(total) ~ 0 + pdq(1,0,1) + PDQ(2,1,1) + log(raskaus_oireet_L9)),
            all_terms=ARIMA(log(total) ~ 0 + pdq(1,0,1) + PDQ(2,1,1) + log(raskaustesti_L9) +  log(alkuraskaus_L8) + log(raskausoireet_L10) + log(raskaus_oireet_L9))
          )
...
##Testing the models from 2016 onwards
...
fit_predictors_training_alternative <- dataset %>% dplyr::filter(between(timestamp,as.Date("2010-01-01"),as.Date("2020-07-01"))) %>% 
      model(Naive=ARIMA(log(total) ~ 0 + pdq(1,0,3) + PDQ(2,1,2)),
            raskaustestiL9=ARIMA(log(total) ~ 0 + pdq(1,0,3) + PDQ(2,1,2) + log(raskaustesti_L9)),
            alkuraskausL8=ARIMA(log(total) ~ 0 + pdq(1,0,3) + PDQ(2,1,2) + log(alkuraskaus_L8)),
            raskausoireetL10=ARIMA(log(total) ~ 0 + pdq(1,0,3) + PDQ(2,1,2) + log(raskausoireet_L10)),
            raskaus_oireetL9=ARIMA(log(total) ~ 0 + pdq(1,0,3) + PDQ(2,1,2) + log(raskaus_oireet_L9)),
            all_terms=ARIMA(log(total) ~ 0 + pdq(1,0,3) + PDQ(2,1,2) + log(raskaustesti_L9) +  log(alkuraskaus_L8) + log(raskausoireet_L10) + log(raskaus_oireet_L9))
          )
...
##fit_predictors_training_alternative %>% forecast(testing_dataset) %>% accuracy(dataset) %>%  dplyr::select(.model, RMSE:MAPE)

##fit_predictors_training_alternative %>% forecast(testing_dataset) %>% autoplot(dataset,level=NULL)
...
#Best model for forecasting purpose is 103210
```
...
fit_t_raskaustesti_first <- dataset %>% dplyr::filter(between(timestamp,as.Date("2010-01-01"),as.Date("2022-07-01"))) %>% 
      model( 
       L0=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti)),
       L3=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L3)),
        L4=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L4)),
        L5=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L5)),
        L6=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L6)),
        L7=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L7)),
        L8=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L8)),
        L9=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L9)),
        L10=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L10)),
        L11=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L11)),
        L12=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L12))
      )
...
fit_t_alkuraskaus_first <- dataset %>% dplyr::filter(between(timestamp,as.Date("2010-01-01"),as.Date("2022-07-01"))) %>% 
      model( 
       L0=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus)),
       L3=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus_L3)),
        L4=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus_L4)),
        L5=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus_L5)),
        L6=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus_L6)),
        L7=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus_L7)),
        L8=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus_L8)),
        L9=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus_L9)),
        L10=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus_L10)),
        L11=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus_L11)),
        L12=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus_L12))
      )
...
fit_t_raskausoireet_first <- dataset %>% dplyr::filter(between(timestamp,as.Date("2010-01-01"),as.Date("2022-07-01"))) %>% 
      model( 
       L0=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet)),
       L3=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet_L3)),
        L4=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet_L4)),
        L5=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet_L5)),
        L6=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet_L6)),
        L7=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet_L7)),
        L8=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet_L8)),
        L9=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet_L9)),
        L10=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet_L10)),
        L11=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet_L11)),
        L12=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet_L12))
      )
...
fit_t_raskaus_oireet_first <- dataset %>% dplyr::filter(between(timestamp,as.Date("2010-01-01"),as.Date("2022-07-01"))) %>% 
      model( 
       L0=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet)),
       L3=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet_L3)),
        L4=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet_L4)),
        L5=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet_L5)),
        L6=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet_L6)),
        L7=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet_L7)),
        L8=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet_L8)),
        L9=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet_L9)),
        L10=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet_L10)),
        L11=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet_L11)),
        L12=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet_L12))
      )
...
fit_predictors_training_first <- dataset %>% dplyr::filter(between(timestamp,as.Date("2010-01-01"),as.Date("2020-07-01"))) %>% 
      model(Naive=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0)),
            raskaustestiL8=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L8)),
            alkuraskausL7=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(alkuraskaus_L7)),
            raskausoireetL10=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskausoireet_L10)),
            raskaus_oireetL7=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaus_oireet_L7)),
            all_terms=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L8) +  log(alkuraskaus_L7) + log(raskausoireet_L10) + log(raskaus_oireet_L7)),
            best_terms=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L8) +  log(alkuraskaus_L7) + log(raskaus_oireet_L7))
          )
...
best_fit_first <- dataset %>% model(best_terms=ARIMA(log(first) ~ 0 + pdq(1,0,3) + PDQ(2,1,0) + log(raskaustesti_L8) +  log(alkuraskaus_L7) + log(raskaus_oireet_L7)))
